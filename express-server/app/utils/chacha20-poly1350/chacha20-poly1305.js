...
module.exports = (key, plaintext, nonce, AAD, counter = 0) => {
  ...
  let aead = aead_encrypt(key, nonce, plaintext, aad)
  console.log('加密后的数据 + Tag', aead)
  let aead_dec = aead_decrypt(key, nonce, aead[0], aad, aead[1])
  console.log('解密后的数据', aead_dec);
  console.log('恢复的数据', buf2Str(aead_dec))
